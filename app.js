...
function cadastrarDespesa() {
  ...
  if (despesa.validarDados()) {
    ...
    document.getElementById('modalDescricao').innerHTML = 'Despesa registrada com sucesso'
    document.getElementById('modalBtn').innerHTML = 'Voltar'

    document.getElementById('modalTitulo').classList.remove('text-danger')
    document.getElementById('modalBtn').classList.remove('btn-danger')

    document.getElementById('modalTitulo').classList.add('text-success')
    ...
    document.getElementById('modalTitulo').classList.remove('text-success')
    document.getElementById('modalBtn').classList.remove('btn-success')

    document.getElementById('modalTitulo').classList.add('text-danger')
